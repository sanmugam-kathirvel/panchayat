...
<div class="blocks form">
    ...
    <div class="actions">
        <ul>
            ...
            <li><?php echo $html->link(__('ரசீது புத்தகத்தை உபயோகிப்பதற்கு வழங்கு', true), array('action' => 'book_issue')); ?></li>
        </ul>
    </div>
    ...
    <table cellpadding="0" cellspacing="0">
        <?php
            $tableHeaders = $html->tableHeaders(array(
                ...
                $paginator->sort('இறுதி ரசீது எண்', 'end_receipt_number'),
            ...
            foreach ($books AS $book) {
                ...
                $rows[] = array(
                    ...
                    $book['BookDetail']['status'] == 'available' ? 'இருக்கின்றது'  : 'வழங்கப்பட்டது' ,
                    $actions,
                );
            }
