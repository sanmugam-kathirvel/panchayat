<h2>பணியாளர்களின் பதிவீடு விபரங்களைத் திருத்து</h2>
<?php
	$hamlet_op = array();
	foreach($hamlets as $hamlet){
		$hamlet_op[$hamlet['Hamlet']['id']] =  $hamlet['Hamlet']['hamlet_code'];
	}
	echo $form->create('NregsRegistration', array( 'url' => array('controller' => 'nregs', 'action' => 'editregistration'), 'type' => 'file'));
	echo $form->input('family_number', array('label' => 'குடும்ப எண்'));
	echo $form->input('job_card_number', array('label' => 'வேலை அட்டை எண்'));
	...
	echo $form->input('ration_card_number', array('label' => 'குடும்ப அட்டை எண்'));
	echo $form->input('voter_id_number', array('label' => 'வாக்காளர் அட்டை எண்'));
	...
	echo $form->input('job_card_issue_date', array('label' => 'வேலை அட்டை வழங்கிய தேதி', 'id' => 'datepicker1', 'type' => 'text'));
