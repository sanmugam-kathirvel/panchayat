    ...
    public function data() {
        ...
        if (isset($this->params['named']['run'])) {
            ...
            if(!$db->isConnected()) {
              ...
              var_dump(ROOT.'/plugins'.DS.'install'.DS.'webroot'.DS.'panchayat.sql');
              $sql = file_get_contents(ROOT.'/plugins'.DS.'install'.DS.'webroot'.DS.'panchayat.sql');
              $db = ConnectionManager::getDataSource('default');
 ...
 */
    public function finish() {
        ...
        $User->saveField('password', Security::hash('admin', null, $salt));
    }
